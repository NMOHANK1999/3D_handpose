...
if __name__ == '__main__':
    ...
    if len(sys.argv) < 3:
        print('Usage: python3 calib.py calibration_settings.yaml [step_number]')
        print('Available steps:')
        print('1: Start from intrinsics')
        print('2: skip intrinsics')
        quit()
    ...
    if step_number == 1:
        ...
        check_calibration('camera0', camera0_data, 'camera1', camera1_data, _zshift = 40.)
